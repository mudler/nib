...
var settingDocs = map[string]string{
	...
	"classifier.api":                          "classifier backend: llm (including OpenAI OAuth) or systemone",
	"classifier.timeout":                      "classifier request deadline (default: llm 30s, SystemOne 2s)",
	"classifier.model":                        "classifier model (llm inherits the endpoint model when empty)",
